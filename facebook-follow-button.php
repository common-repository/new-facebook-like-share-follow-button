...
class FbSocialFollowButton extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array ( 
			'classname' => __('Facebook Follow Button', NSMW_TXTDM),
			'description' => __('This is facebook follow widget you can add this in a widget area or wherever you want it is very easy to use.', NSMW_TXTDM),
		);
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'layout_style' ) ); ?>"><?php _e('Button Layout Style', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'layout_style' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'layout_style' ) ); ?>">
				<option value="standard" <?php if($layout_style == 'standard' ) echo "selected=selected"; ?> ><?php _e('Standerd', NSMW_TXTDM); ?></option>
				<option value="box_count" <?php if($layout_style == 'box_count' ) echo "selected=selected"; ?>><?php _e('Box count', NSMW_TXTDM); ?></option>
				<option value="button_count" <?php if($layout_style == 'button_count' ) echo "selected=selected"; ?>><?php _e('Button count', NSMW_TXTDM); ?></option>
				<option value="button" <?php if($layout_style == 'button' ) echo "selected=selected"; ?>><?php _e('Button', NSMW_TXTDM); ?></option>
			</select>
		</p>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Height:', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('height'); ?>" name="<?php echo $this->get_field_name('height'); ?>" type="text" value="<?php echo $height; ?>" />
			</label>
		</p>
		<p>
