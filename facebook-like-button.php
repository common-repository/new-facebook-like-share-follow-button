...
class FbSocialLikeButton extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			'classname' => __('Facebook Like Button', NSMW_TXTDM), 
			'description' => __('This is facebook like widget you can add this in a widget area or wherever you want it is very easy to use.', NSMW_TXTDM), 
		);
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('url'); ?>"><?php _e('Share url', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('url'); ?>" name="<?php echo $this->get_field_name('url'); ?>" type="text" value="<?php echo $url; ?>" />
			</label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Width', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('width'); ?>" name="<?php echo $this->get_field_name('width'); ?>" type="text" value="<?php echo $width; ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>"><?php _e('Button Layout', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'layout' ) ); ?>">
				<option value="standard" <?php if($layout == 'standard' ) echo "selected=selected"; ?> ><?php _e('standard', NSMW_TXTDM); ?></option>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'action_type' ) ); ?>"><?php _e('Button Action Type', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'action_type' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'action_type' ) ); ?>">
				<option value="like" <?php if($action_type == 'like' ) echo "selected=selected"; ?> ><?php _e('Like', NSMW_TXTDM); ?></option>
				<option value="recommend" <?php if($action_type == 'recommend' ) echo "selected=selected"; ?>><?php _e('Recommend', NSMW_TXTDM); ?></option>
			</select>
		</p>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show_faces' ); ?>"><?php _e( 'Enable Show Faces', NSMW_TXTDM); ?></label><br>
			<input class="widefat" id="<?php echo $this->get_field_id( 'show_faces' ); ?>" name="<?php echo $this->get_field_name( 'show_faces' ); ?>" <?php if($show_faces == 'true') echo "checked=checked" ?> type="radio" value="true"> <?php _e('Yes', NSMW_TXTDM); ?> &nbsp;&nbsp;
			<input class="widefat" id="<?php echo $this->get_field_id( 'show_faces' ); ?>" name="<?php echo $this->get_field_name( 'show_faces' ); ?>" <?php if($show_faces == 'false') echo "checked=checked" ?> type="radio" value="false"> <?php _e('No', NSMW_TXTDM); ?>
		</p>
		<p>
