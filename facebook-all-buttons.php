...
class FbSocialFacebookButtons extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			'classname' => __('Facebook Like Share Follow Button', NSMW_TXTDM), 
			'description' => __('This is facebook like share follow widget you can add this in a widget area or wherever you want it is very easy to use.', NSMW_TXTDM), 
		);
	...
	public function widget( $args, $instance ) {
		...
		$share_button_url = ! empty( $instance['share_button_url'] ) ? $instance['share_button_url'] : '';
		$share_button_url_type = ! empty( $instance['share_button_url_type'] ) ? $instance['share_button_url_type'] :'';
		$share_button_layout = ! empty( $instance['share_button_layout'] ) ? $instance['share_button_layout'] :  '';
		$share_button_button_size = ! empty( $instance['share_button_button_size'] ) ? $instance['share_button_button_size'] : '';
		$share_button_mobile_frame = ! empty( $instance['share_button_mobile_frame'] ) ? $instance['share_button_mobile_frame'] : '';
		...
		$follow_button_height = ! empty( $instance['follow_button_height'] ) ? $instance['follow_button_height'] : '';
		...
		<div class="fb-share-button" data-toggle="tooltip" title="Share on facebook!"  data-href="<?php echo $share_button_url; ?>" data-layout="<?php echo $share_button_layout; ?>" data-size="<?php echo $share_button_button_size; ?>" data-mobile-iframe="<?php echo $share_button_mobile_frame; ?>">
			<a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($share_button_url); ?>&amp;src=sdkpreparse">Share', NSMW_TXTDM); ?></a>
		</div>
	...
	public function form( $instance ) {
		...
		<!--facbook like button-->
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Widget Title', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
			</label>
		</p>
		<h2 class="fb-heading"><?php _e('Facebook Like Button Settings', NSMW_TXTDM); ?></h2>
		<hr>
		<p>
			<label for="<?php echo $this->get_field_id('like_button_url'); ?>"><?php _e('Share Url', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('like_button_url'); ?>" name="<?php echo $this->get_field_name('like_button_url'); ?>" type="text" value="<?php echo $like_button_url; ?>" />
			</label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id('like_button_width'); ?>"><?php _e('Width', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('like_button_width'); ?>" name="<?php echo $this->get_field_name('width'); ?>" type="text" value="<?php echo $like_button_width; ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'like_button_layout' ) ); ?>"><?php _e('Button Layout', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'like_button_layout' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'like_button_layout' ) ); ?>">
				<option value="standard" <?php if($like_button_layout == 'standard' ) echo "selected=selected"; ?> ><?php _e('standard', NSMW_TXTDM); ?></option>
				<option value="box_count" <?php if($like_button_layout == 'box_count' ) echo "selected=selected"; ?>><?php _e('Box count', NSMW_TXTDM); ?></option>
				<option value="button_count" <?php if($like_button_layout == 'button_count' ) echo "selected=selected"; ?>><?php _e('Button count', NSMW_TXTDM); ?></option>
				<option value="button" <?php if($like_button_layout == 'button' ) echo "selected=selected"; ?>><?php _e('Button', NSMW_TXTDM); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'like_button_action_type' ) ); ?>"><?php _e('Button Action Type', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'like_button_action_type' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'like_button_action_type' ) ); ?>">
				<option value="like" <?php if($like_button_action_type == 'like' ) echo "selected=selected"; ?> ><?php _e('Like', NSMW_TXTDM); ?></option>
				<option value="recommend" <?php if($like_button_action_type == 'recommend' ) echo "selected=selected"; ?>><?php _e('Recommend', NSMW_TXTDM); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'like_button_button_size' ) ); ?>"><?php _e('Button Size', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'like_button_button_size' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'like_button_button_size' ) ); ?>">
				<option value="small" <?php if($like_button_button_size == 'small' ) echo "selected=selected"; ?> ><?php _e('Small', NSMW_TXTDM); ?></option>
				<option value="large" <?php if($like_button_button_size == 'large' ) echo "selected=selected"; ?>><?php _e('Large', NSMW_TXTDM); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'like_button_show_faces' ); ?>"><?php _e( 'Enable Show Faces', NSMW_TXTDM); ?></label><br>
			<input class="widefat" id="<?php echo $this->get_field_id( 'like_button_show_faces' ); ?>" name="<?php echo $this->get_field_name( 'like_button_show_faces' ); ?>" <?php if($like_button_show_faces == 'true') echo "checked=checked" ?> type="radio" value="true"> <?php _e('Yes', NSMW_TXTDM); ?> &nbsp;&nbsp;
			<input class="widefat" id="<?php echo $this->get_field_id( 'like_button_show_faces' ); ?>" name="<?php echo $this->get_field_name( 'like_button_show_faces' ); ?>" <?php if($like_button_show_faces == 'false') echo "checked=checked" ?> type="radio" value="false"> <?php _e('No', NSMW_TXTDM); ?>
		</p>
		<br>
		
		<!--facbook share button-->
		<h2 class="fb-heading"><?php _e('Facebook Share Button Settings', NSMW_TXTDM); ?></h2>
		<hr>
		<p>
			<label for="<?php echo $this->get_field_id( 'share_button_url_type' ); ?>"><?php _e( 'Share URL', NSMW_TXTDM); ?></label><br>
			<input class="widefat dynamic" id="<?php echo $this->get_field_id( 'share_button_url_type' ); ?>" name="<?php echo $this->get_field_name( 'share_button_url_type' ); ?>" <?php if($share_button_url_type == 'dynamic') echo "checked=checked" ?> type="radio" value="dynamic"> <?php _e('Dynamic', NSMW_TXTDM); ?> &nbsp;&nbsp;
			<input class="widefat static" id="<?php echo $this->get_field_id( 'share_button_url_type' ); ?>" name="<?php echo $this->get_field_name( 'share_button_url_type' ); ?>" <?php if($share_button_url_type == 'static') echo "checked=checked" ?> type="radio" value="static"> <?php _e('Static', NSMW_TXTDM); ?>
		</p>
		<p class="url-feild" <?php if($share_button_url_type == "dynamic") { ?> style="display:none"; <?php } ?>>
			<label for="<?php echo $this->get_field_id('share_button_url'); ?>"><?php _e('Url to share:', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('share_button_url'); ?>" name="<?php echo $this->get_field_name('share_button_url'); ?>" type="text" value="<?php echo $share_button_url; ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'share_button_layout' ) ); ?>"><?php _e('Button Layout', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'share_button_layout' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'share_button_layout' ) ); ?>">
				<option value="box_count" <?php if($share_button_layout == 'box_count' ) echo "selected=selected"; ?> ><?php _e('Box Count', NSMW_TXTDM); ?></option>
				<option value="button_count" <?php if($share_button_layout == 'button_count' ) echo "selected=selected"; ?>><?php _e('Button Count', NSMW_TXTDM); ?></option>
				<option value="button" <?php if($share_button_layout == 'button' ) echo "selected=selected"; ?>><?php _e('Button', NSMW_TXTDM); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'share_button_button_size' ) ); ?>"><?php _e('Button Size', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'share_button_button_size' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'share_button_button_size' ) ); ?>">
				<option value="small" <?php if($share_button_button_size == 'small' ) echo "selected=selected"; ?> ><?php _e('Small', NSMW_TXTDM); ?></option>
				<option value="large" <?php if($share_button_button_size == 'large' ) echo "selected=selected"; ?>><?php _e('Large', NSMW_TXTDM); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'share_button_mobile_frame' ); ?>"><?php _e( 'Enable Mobile Frame', NSMW_TXTDM); ?></label><br>
			<input class="widefat" id="<?php echo $this->get_field_id( 'share_button_mobile_frame' ); ?>" name="<?php echo $this->get_field_name( 'share_button_mobile_frame' ); ?>" <?php if($share_button_mobile_frame == 'true') echo "checked=checked" ?> type="radio" value="true"> <?php _e('Yes', NSMW_TXTDM); ?> &nbsp;&nbsp;
			<input class="widefat" id="<?php echo $this->get_field_id( 'share_button_mobile_frame' ); ?>" name="<?php echo $this->get_field_name( 'share_button_mobile_frame' ); ?>" <?php if($share_button_mobile_frame == 'false') echo "checked=checked" ?> type="radio" value="false"> <?php _e('No', NSMW_TXTDM); ?>
		</p>
		<br>
		
		<!--facbook follow button-->
		<h2 class="fb-heading"><?php _e('Facebook Follow Button', NSMW_TXTDM); ?></h2>
		<hr>
		<p>
			<label for="<?php echo $this->get_field_id('follow_button_url'); ?>"><?php _e('Share Url', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('follow_button_url'); ?>" name="<?php echo $this->get_field_name('follow_button_url'); ?>" type="text" value="<?php echo $follow_button_url; ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'follow_button_layout_style' ) ); ?>"><?php _e('Button Layout Style:', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'follow_button_layout_style' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'follow_button_layout_style' ) ); ?>">
				<option value="standard" <?php if($follow_button_layout_style == 'standard' ) echo "selected=selected"; ?> ><?php _e('Standerd', NSMW_TXTDM); ?></option>
				<option value="box_count" <?php if($follow_button_layout_style == 'box_count' ) echo "selected=selected"; ?>><?php _e('Box count', NSMW_TXTDM); ?></option>
				<option value="button_count" <?php if($follow_button_layout_style == 'button_count' ) echo "selected=selected"; ?>><?php _e('Button count', NSMW_TXTDM); ?></option>
				<option value="button" <?php if($follow_button_layout_style == 'button' ) echo "selected=selected"; ?>><?php _e('Button', NSMW_TXTDM); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'follow_button_button_size' ) ); ?>"><?php _e('Button Size', NSMW_TXTDM); ?></label> 
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'follow_button_button_size' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'follow_button_button_size' ) ); ?>">
				<option value="small" <?php if($follow_button_button_size == 'small' ) echo "selected=selected"; ?> ><?php _e('Small', NSMW_TXTDM); ?></option>
				<option value="large" <?php if($follow_button_button_size == 'large' ) echo "selected=selected"; ?>><?php _e('Large', NSMW_TXTDM); ?></option>
			</select>
		</p>		
		<p>
			<label for="<?php echo $this->get_field_id('follow_button_width'); ?>"><?php _e('Width', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('follow_button_width'); ?>" name="<?php echo $this->get_field_name('follow_button_width'); ?>" type="text" value="<?php echo $follow_button_width; ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('follow_button_height'); ?>"><?php _e('Height', NSMW_TXTDM); ?><input class="widefat" id="<?php echo $this->get_field_id('follow_button_height'); ?>" name="<?php echo $this->get_field_name('follow_button_height'); ?>" type="text" value="<?php echo $follow_button_height; ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'follow_button_show_faces' ); ?>"><?php _e( 'Enable Show Faces', NSMW_TXTDM); ?></label><br>
			<input class="widefat" id="<?php echo $this->get_field_id( 'follow_button_show_faces' ); ?>" name="<?php echo $this->get_field_name( 'follow_button_show_faces' ); ?>" <?php if($follow_button_show_faces == 'true') echo "checked=checked" ?> type="radio" value="true"> <?php _e('Yes', NSMW_TXTDM); ?> &nbsp;&nbsp;
			<input class="widefat" id="<?php echo $this->get_field_id( 'follow_button_show_faces' ); ?>" name="<?php echo $this->get_field_name( 'follow_button_show_faces' ); ?>" <?php if($follow_button_show_faces == 'false') echo "checked=checked" ?> type="radio" value="false"> <?php _e('No', NSMW_TXTDM); ?>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'language' ); ?>"><?php _e( 'Widget Defalut Language', NSMW_TXTDM); ?></label><br>
